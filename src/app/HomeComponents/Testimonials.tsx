    ...
    <section className="py-16 bg-white relative">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="relative">
          ...
          <button
            ref={nextRef}
            className="absolute top-1/2 lg:right-30 right-5 z-20 transform -translate-y-1/2 bg-red-500 text-white p-3 rounded-full shadow-md hover:bg-red-600 transition"
          >
            <FaArrowRight />
          </button>
